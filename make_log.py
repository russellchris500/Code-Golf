...
def create_type_sorted_log():
    ...
    with open('score_log_type.txt', 'w') as out:
        out.write(f"{'Task':<10} {'Public':<8} {'Private':<10} {'Best':<6} {'Deficit':<8} {'Type':<30}\n")
        out.write("-" * 72 + "\n")
        ...
        for data in task_data:
            ...
            out.write(f"Task {data['task_num']:<5} {public_display:<8} {solution_display:<10} {best_display:<6} {deficit_display:<8} {type_display:<30}\n")
